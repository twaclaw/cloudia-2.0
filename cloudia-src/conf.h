...
#define CONF_PERIOD_MINS_BIT (1 << 6)
#define CONF_PERIOD_MINS_HRS_VALUE_MASK (0x3F)
#define CONF_PERIOD_SECS_VALUE_MASK (0x7F)

//PORTS
#define CONF_PORT 144
#define CONF_PORT_SINGLE_MEAS 70
#define CONF_PORT_MULT_MEAS_OFFSET_0 80
#define CONF_PORT_MULT_MEAS_OFFSET_GT_0 81
#define CONF_PORT_MULT_MEAS_OFFSET_0_DIFFS 90
#define CONF_PORT_MULT_MEAS_OFFSET_GT_0_DIFFS 91
#define CONF_PORT_MULT_MEAS_OFFSET_0_ALL_DIFFS_ZERO 92
#define CONF_PORT_MULT_MEAS_OFFSET_GT_0_ALL_DIFFS_ZERO 93
...
#define CONF_SR4_TDIFF_BIT (5)
#define CONF_SR4_TDIFF_MASK (0x7)
#define CONF_SR4_HDIFF_BIT (2)
#define CONF_SR4_HDIFF_MASK (0x7)
